...
export const seriesList: ProductSeries[] = [
  ...
  },
  {
    ...
    description: 'Hanging car air fresheners in various fragrances, shapes, and designs for rearview mirror or grab handle placement.',
    image: img(4),
  },
  {
    id: 'ser-af-02',
    ...
    categorySlug: 'air-fresheners',
    description: 'Vent clip air fresheners that attach to AC vents for even fragrance distribution throughout the cabin.',
    image: img(1),
  },
  {
    id: 'ser-af-03',
    ...
    categorySlug: 'air-fresheners',
    description: 'Dashboard-mounted air fresheners in various designs, fragrances, and sizes for stylish interior scent delivery.',
    image: img(2),
  },
  {
    id: 'ser-af-04',
    name: 'Can Air Fresheners',
    slug: 'can-air-fresheners',
    categorySlug: 'air-fresheners',
    description: 'Gel can and tin-type air fresheners in various fragrances, sizes, and lid designs for long-lasting cabin freshness.',
    image: img(3),
  },
  {
    id: 'ser-af-05',
    name: 'Solar Air Fresheners',
    slug: 'solar-air-fresheners',
    categorySlug: 'air-fresheners',
    description: 'Solar-powered rotating air fresheners that activate with sunlight for continuous fragrance circulation without batteries.',
    image: img(4),
  },
  {
    id: 'ser-af-06',
    ...
    categorySlug: 'air-fresheners',
    description: 'Ultrasonic and evaporative aroma diffusers designed for vehicle use with various mist modes and LED lighting options.',
    image: img(1),
  },
  {
    id: 'ser-af-07',
    ...
    categorySlug: 'air-fresheners',
    description: 'Liquid perfume bottle air fresheners in premium glass and metal designs with adjustable scent intensity control.',
    image: img(2),
  },
  {
    id: 'ser-af-08',
    name: 'Gel Air Fresheners',
    slug: 'gel-air-fresheners',
    categorySlug: 'air-fresheners',
    description: 'Gel-based air fresheners in various container styles, fragrances, and sizes for long-lasting steady scent release.',
    image: img(3),
  },
  {
    id: 'ser-af-09',
    name: 'OEM Air Fresheners',
    slug: 'oem-air-fresheners',
    categorySlug: 'air-fresheners',
    description: 'Custom OEM air fresheners with private label options, custom fragrances, packaging design, and brand printing available.',
    image: img(4),
  },
  {
    id: 'ser-int-09',
